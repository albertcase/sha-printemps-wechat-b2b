...
<script type="text/javascript">
	...
	function funTips(callBt){
		...
		setTimeout('$(".login_tips").removeClass("error").html("欢迎关注<br />法国春天百货PRINTEMPS商务微信号<br /><span>此微信号仅用于商务交流，如果您是春天百货的客人，请关注春天百货的官方公众号。如果您是春天百货的商务伙伴，请通过您的春天商务编号与您的姓氏拼音登录，谢谢！</span>");', 2000)
	}
		...
		if(codenum == ""){
			...
			$.ajax({
		    	...
		    	if(data.code == 1){
		    		...
		    		callbackTips = "<em>很抱歉，登陆失败<br>请重新输入</em><p>如需要联系法国春天百货国际部</p><p>请致电：<a href='tel:+33142825579'>+33 1 42 82 55 79</a> <br /><a href='tel:+33142825580'>+33 1 42 82 55 80</a></p><br>";
		    	}
